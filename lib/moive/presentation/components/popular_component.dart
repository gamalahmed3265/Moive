  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MoivesBloc, MoivesState>(
        buildWhen: (previous, current) =>
            previous.stateNowPlayingRequest != current.stateNowPlayingRequest,
        builder: (context, state) {
          print(
              " stateMoivePopularRequest ----- ${state.stateMoivePopularRequest} ----");
          return screenSwatich(
              state.stateMoivePopularRequest,
              FadeIn(
                ...
                child: SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemCount: state.moivesMoivePopular.length,
                    itemBuilder: (context, index) {
                      final movie = state.moivesMoivePopular[index];
                      return Container(
